...
/**
 * Brave extension of {@link ContextMenuManager.Delegate} for NTP top-sites widget management.
 * When implemented by a tile's interaction delegate, the long-press context menu will prepend
 * "Add site" and append "Show frequently visited / Show shortcuts / Hide widget" (below a
 * divider) to the standard Chromium items.
 */
@NullMarked
public interface BraveNtpDelegate extends ContextMenuManager.Delegate {
     ...
     *
     * @param menuItemId One of {@link #BRAVE_ADD_SITE}, {@link #BRAVE_SHOW_FREQUENT},
     *     {@link #BRAVE_SHOW_SHORTCUTS}, {@link #BRAVE_HIDE_WIDGET}.
     */
